    ...
    <div class="footer-grid">
        ...
        <div class="footer-col">
            ...
            <div class="footer-contact-item">
                ...
                <a href="/cdn-cgi/l/email-protection#cda4a3aba28da9acfca0a2b9a2bfbee3aea2a0"><span
                        class="__cf_email__"
                        data-cfemail="630a0d050c230702520e0c170c11104d000c0e">[email&#160;protected]</span></a>
            </div>
            <div class="footer-contact-item">
...
<div id="da1-chat-widget" class="da1-chat-collapsed">
    
    <button id="da1-chat-icon" title="Contacta con DA1 AI">
        <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M12 2C10.5 3 9 4.5 8 6C7.5 5.5 6 4.5 5 4C4.5 4.5 4 5.5 4 6.5C4 7 4.5 8 5 8.5C3.5 9 2 10.5 2 12C2 13.5 3.5 15 5 15.5C4.5 16 4 17 4 17.5C4 18.5 4.5 19.5 5 20C6 19.5 7.5 18.5 8 18C9 19.5 10.5 21 12 22C13.5 21 15 19.5 16 18C16.5 18.5 18 19.5 19 20C19.5 19.5 20 18.5 20 17.5C20 17 19.5 16 19 15.5C20.5 15 22 13.5 22 12C22 10.5 20.5 9 19 8.5C19.5 8 20 7 20 6.5C20 5.5 19.5 4.5 19 4C18 4.5 16.5 5.5 16 6C15 4.5 13.5 3 12 2Z" fill="var(--da1-red, #e8001c)"/>
        </svg>
    </button>
    
    <div id="da1-chat-window">
        <div class="da1-chat-header">
            <div class="da1-chat-title-group">
                <svg viewBox="0 0 24 24" class="da1-bat-mini"><path d="M12 2C10.5 3 9 4.5 8 6C7.5 5.5 6 4.5 5 4C4.5 4.5 4 5.5 4 6.5C4 7 4.5 8 5 8.5C3.5 9 2 10.5 2 12C2 13.5 3.5 15 5 15.5C4.5 16 4 17 4 17.5C4 18.5 4.5 19.5 5 20C6 19.5 7.5 18.5 8 18C9 19.5 10.5 21 12 22C13.5 21 15 19.5 16 18C16.5 18.5 18 19.5 19 20C19.5 19.5 20 18.5 20 17.5C20 17 19.5 16 19 15.5C20.5 15 22 13.5 22 12C22 10.5 20.5 9 19 8.5C19.5 8 20 7 20 6.5C20 5.5 19.5 4.5 19 4C18 4.5 16.5 5.5 16 6C15 4.5 13.5 3 12 2Z" fill="white"/></svg>
                <h3>DA1 VIP Assistant</h3>
            </div>
            <button id="da1-chat-close" title="Cerrar">&times;</button>
        </div>
        
        <div id="da1-chat-messages">
            <div class="da1-msg da1-msg-ai">Bienvenido a DA1MOTORS. Soy su asistente personal. ¿En qué hiperdeportivo está interesado hoy?</div>
        </div>
        
        <div class="da1-chat-input-area">
            <input type="text" id="da1-chat-input" placeholder="Pregunte sobre el Chiron Super Sport...">
            <button id="da1-chat-send">
                <svg viewBox="0 0 24 24"><path d="M2 21L23 12L2 3V10L17 12L2 14V21Z" fill="white"/></svg>
            </button>
        </div>
    </div>
</div>