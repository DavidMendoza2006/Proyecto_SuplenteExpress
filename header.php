        ...
        <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-1">
          ...
          <li class="nav-item da1-user-parent">
            ...
            <div class="da1-user-menu">
              <a class="da1-user-item" href="user.php?tab=login">
                <i class="bi bi-box-arrow-in-right"></i> Iniciar sesión
              </a>
              <a class="da1-user-item" href="user.php?tab=register">
                <i class="bi bi-person-plus"></i> Registrarse
              </a>
              <div class="da1-user-divider"></div>
              <a class="da1-user-item" href="user.php" onclick="sessionStorage.setItem('da1_demo_redirect','1')">
                <i class="bi bi-person-circle"></i> Mi Perfil
              </a>
              <div class="da1-user-divider"></div>
              <a class="da1-user-item" href="#" onclick="event.preventDefault(); sessionStorage.removeItem('da1_user'); let t = document.createElement('div'); t.style.cssText = 'position:fixed;bottom:32px;right:32px;background:#161616;border:1px solid #333;border-left:3px solid #e8001c;border-radius:4px;padding:16px 20px;display:flex;align-items:center;gap:12px;font-size:13px;color:#fff;z-index:9999;box-shadow:0 8px 32px rgba(0,0,0,.6);transform:translateX(120%);transition:transform .35s ease;font-family:sans-serif;'; t.innerHTML = '<i class=\'bi bi-check-circle-fill\' style=\'color:#e8001c;font-size:16px;\'></i><span>Cerrando sesión...</span>'; document.body.appendChild(t); setTimeout(()=>t.style.transform='translateX(0)',10); setTimeout(()=>window.location.href='index.php', 1200);">
